  ...
  function getSettingsInitController() {
    if (!settingsInitController) {
      settingsInitController = createSettingsInitController({
        ...
        syncSettingsLists: resolveDelegate("syncSettingsLists"),
        updateTemplateLengthHint: resolveDelegate("updateTemplateLengthHint"),
        loadLatestDiagnosticReport: resolveDelegate("loadLatestDiagnosticReport"),
        handlers: {
          ...
          onRunEnvironmentDoctorManual: resolveDelegate("runEnvironmentDoctorManual"),
          onLoadLatestDiagnosticReport: resolveDelegate("loadLatestDiagnosticReport"),
          onLoadParseDebugReport: resolveDelegate("loadParseDebugReport"),
